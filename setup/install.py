...
if EXEC_DIR.endswith('/pattoo-agent-opcua/setup') is True:
...
Other steps:
    1) You can make the various pattoo agents be system daemons by running the
       ...
       https://github.com/PalisadoesFoundation/pattoo-agent-opcua/tree/master/setup/systemd
