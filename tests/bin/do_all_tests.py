#!/usr/bin/env python3
"""Script to test all the pattoo-agent-opcua unittests.
...
_EXPECTED = '{0}pattoo-agent-opcua{0}tests{0}bin'.format(os.sep)
...
def main():
    """Test all the pattoo-agent-opcua modules with unittests.
...
def run_script(cli_string):
    ...
    pattoo_returncode = ('----- pattoo-agent-opcua Return Code '
                         '----------------------------------------')
    pattoo_stdoutdata = ('----- pattoo-agent-opcua Test Output '
                         '----------------------------------------')
    pattoo_stderrdata = ('----- pattoo-agent-opcua Test Error '
                         '-----------------------------------------')
