...
_EXPECTED = '{0}pattoo-agent-opcua{0}bin'.format(os.sep)
...
from pattoo_agent_opcua import PATTOO_AGENT_OPCUAD
from pattoo_agent_opcua import collector
from pattoo_agent_opcua.configuration import ConfigOPCUA as Config
